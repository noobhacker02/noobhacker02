...
<h3 style="margin: 0;">
  <a href="https://github.com/noobhacker02/CustomTrainedCasualLLm_FastAPIChatBot" style="color: #58a6ff; text-decoration: none;">
...
<p style="margin: 12px 0;">
  <img src="https://img.shields.io/badge/ai-blueviolet?style=for-the-badge" alt="ai">
</p>
...
<p style="margin: 16px 0;">
  ...
  <img src="https://img.shields.io/badge/⚡_JavaScript-informational?style=flat-square" alt="language">
</p>

<a href="https://github.com/noobhacker02/CustomTrainedCasualLLm_FastAPIChatBot" style="display: inline-block; padding: 10px 20px; background: linear-gradient(135deg, #1f6feb 0%, #1158c7 100%); color: white; text-decoration: none; border-radius: 6px; font-weight: 600; margin-top: 8px;">
  View Project →
</a>
...
<h3 style="margin: 0;">
  <a href="https://github.com/noobhacker02/LangChain_Jup_NoteBook" style="color: #58a6ff; text-decoration: none;">
...
<p style="margin: 16px 0;">
  <img src="https://img.shields.io/badge/⭐_Stars-0-yellow?style=flat-square" alt="stars">
  <img src="https://img.shields.io/badge/📓_Jupyter_Notebook-informational?style=flat-square" alt="language">
</p>

<a href="https://github.com/noobhacker02/LangChain_Jup_NoteBook" style="display: inline-block; padding: 10px 20px; background: linear-gradient(135deg, #1f6feb 0%, #1158c7 100%); color: white; text-decoration: none; border-radius: 6px; font-weight: 600; margin-top: 8px;">
  View Project →
</a>
...
<h3 style="margin: 0;">
  <a href="https://github.com/noobhacker02/Enhanced-RAG-Multi-Index-Chroma-Conversational-Agent" style="color: #58a6ff; text-decoration: none;">
...
<a href="https://github.com/noobhacker02/Enhanced-RAG-Multi-Index-Chroma-Conversational-Agent" style="display: inline-block; padding: 10px 20px; background: linear-gradient(135deg, #1f6feb 0%, #1158c7 100%); color: white; text-decoration: none; border-radius: 6px; font-weight: 600; margin-top: 8px;">
  View Project →
</a>
...
<h3 style="margin: 0;">
  <a href="https://github.com/noobhacker02/Low-Rank-Adaptation_Collab_Notebooks" style="color: #58a6ff; text-decoration: none;">
...
<a href="https://github.com/noobhacker02/Low-Rank-Adaptation_Collab_Notebooks" style="display: inline-block; padding: 10px 20px; background: linear-gradient(135deg, #1f6feb 0%, #1158c7 100%); color: white; text-decoration: none; border-radius: 6px; font-weight: 600; margin-top: 8px;">
  View Project →
</a>
...
<h3 style="margin: 0;">
  <a href="https://github.com/noobhacker02/BrainNakama" style="color: #58a6ff; text-decoration: none;">
    🔥 BrainNakama
  </a>
</h3>
...
<p style="margin: 16px 0;">
  <img src="https://img.shields.io/badge/⭐_Stars-0-yellow?style=flat-square" alt="stars">
  <img src="https://img.shields.io/badge/🐍_Python-informational?style=flat-square" alt="language">
</p>

<a href="https://github.com/noobhacker02/BrainNakama" style="display: inline-block; padding: 10px 20px; background: linear-gradient(135deg, #1f6feb 0%, #1158c7 100%); color: white; text-decoration: none; border-radius: 6px; font-weight: 600; margin-top: 8px;">
  View Project →
</a>
